...
<div class="contatiner">
        ...
        <div class="col-md-6 ml-auto mr-auto">
            ...
            <div class="card-body">
                <div class="card-actions">
                   ...
                   <a href="/papers"><button type="button" class="btn btn-default btn-link" rel="tooltip" data-placement="bottom" title="Go to exercises books page">
    ...
    <div class="row">
        <div class="col-md-12 ml-auto mr-auto">
            ...
            <div class="card-body">
                <div class="card-actions">
                    <a href="/materials/create"><button type="button" class="btn btn-info btn-link" rel="tooltip" data-placement="bottom" title="Create new course material">
                      <i class="material-icons">add</i>Create
                    </button></a>
                        ...
                        @foreach ($new_exercises as $exercise)    
                          <tr>
                            ...
                            @php
                                ...
                                //用于判断显示问题  judge the correct answer for the quesiton
                                $correctAns = 0;
                                $h = $exercise->hide;
                                if ($h == 1) {
